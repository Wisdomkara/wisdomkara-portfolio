          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <img
                ...
                className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-white shadow-2xl transition duration-300"
              />
