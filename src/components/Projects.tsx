...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A real estate web-app that serves as an e-commerce web app that allows purchase and enquiries",
      image: "amaechi.webp",
    ...
    },
    {
      ...
      category: "automation",
      description: "Chat automation with CRM & Supabase",
      image: "/projects/chat-automation.png",
