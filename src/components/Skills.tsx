  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "GoHighLevel", level: 90, color: "from-blue-400 to-blue-600" },
        {
          name: "Social Meddia Management",
          level: 90,
          color: "from-yellow-400 to-yellow-600",
        },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            ...
            skills that enable me to build exceptional web experiences, get
            Client and work effectively in any environment.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-400 pl-4">
                ...
                <p className="text-slate-400 text-sm">
                  Graduated with focus on software development, system design
